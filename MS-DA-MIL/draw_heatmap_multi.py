...
def draw_heatmap(slideID, attention_dir, save_dir):
    ...
    with open(attention_file, 'r') as f:
        ...
        for row in reader:
            ...
            if(mag=='x10'):
                for i in range(2):
                    draw_x10.rectangle((w_pos*t_size+i, h_pos*t_size+i, (w_pos+1)*t_size-i, (h_pos+1)*t_size-i), fill=color, outline=color)
            if(mag=='x20'):
                for i in range(2):
                    draw_x20.rectangle((w_pos*t_size+i, h_pos*t_size+i, (w_pos+1)*t_size-i, (h_pos+1)*t_size-i), fill=color, outline=color)
